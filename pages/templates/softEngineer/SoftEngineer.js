      ...
      >
        ...
        <Box w="50%" mt="10%">
          ...
          <HeadingText
            ...
            wordSpacing="6px"
          />
          <Text fontSize="1.5rem" textAlign="justify" pt="5%">
...
A U G 2 0 1 6 - A U G 2 0 2 0"
        ...
        {/* Right Section  */}
        <Box w="50%">
          <Image src="/SeTemplate.jpg" w="100%" borderRadius="100%" ml="15%" />
          <HeadingText
