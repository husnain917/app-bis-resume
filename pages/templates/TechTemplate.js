...
import TechProfile from '../../src/components/techTemplate/TechProfile';
  ...
  return (
    ...
    <div className={style.main}>
      ...
      <Flex
        ...
        bg={'blackAlpha.100'}
      >
        <Box minW={910} py={2} px={2} bg={'white'} m={4} borderRadius={6}>
          {/* =============== Profile Section =============== */}
          <TechProfile />
...
export default connect(mapStateToProps, { onBlurField })(TechTemplate);
