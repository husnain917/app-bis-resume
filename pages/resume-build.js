    ...
    <>
      <div>
        ...
        >
          ...
          <Box maxW={["100%", "100%", "70%", "70%", "70%"]}>
            <Box marginTop="10%">
              <Text className={"only-font-family"} fontSize={"16px"}>
                With BisResumes free resume builder, applying for your dream job
                is easy and fast. Choose from hundreds of free, designer-made
                templates and customize them within a few clicks.
              </Text>

              <Box mt={["7%", "7%", "7%"]}>
                <Image src={contentImage} alt={"Image Not Found"} />
              </Box>
              <Text
              ...
              >
                ...
                online with BisResume’s free resume builder will give you a
                sleek and attractive resume, without the fuss.
              </Text>
              <Text
                className={"only-font-family"}
                fontSize={"16px"}
              ...
              >
                ...
                <Box marginTop="5%">
                  ...
                  <Text
                    ...
                    mr={["2%", "2%", "0%"]}
                  >
                    Choose from hundreds of professionally-designed resume
                    templates. Take your pick from styles like modern or simple
                    layouts or industries like acting, graphic design or more
                    corporate layouts.
                  </Text>
                </Box>
                <Box marginTop="5%">
                  ...
                  <Text
                    ...
                    mr={["2%", "2%", "0%"]}
                  >
                    After picking a template, use BisResumes drag and drop
                    design tools to tweak your resume. Change fonts, text and
                    colors in a few clicks. Upload your own photo and rearrange
            ...
            <>
              <Container maxW={["100%", "100%", "100%", "100%", "100%"]}>
                <Box marginTop="10%">
                  ...
                  <Text className={"only-font-family"} fontSize={"16px"}>
                    With BisResumes free resume builder, weve taken the heavy
                    lifting out of designing and formatting your resume. Using
                    our flexible templates will save you hours—all you need to
                    do is add your professional experience and customize the
                    existing design as needed.
                  </Text>
                  ...
                  >
                    ...
                    look—because they already look great!
                  </Text>
                  <Text
                    className={"only-font-family"}
                    fontSize={"16px"}
                  ...
                  >
                    ...
                    designer-made templates and customize them within a few
                    clicks.
                  </Text>
                  ...
                  <Box marginTop="5%">
                    ...
                    >
                      ...
                      BisResume’s graphic designers have created a wide range of
                      templates that are suitable for whatever industry you find
                      yourself in.
                    </Text>
                    ...
                    >
                      ...
                      something more formal, you can explore our collection of
                      minimalist templates, sure to impress the most traditional
                      of hiring managers.
                    </Text>
                  </Box>
                  ...
                  <Box marginTop="5%">
                    ...
                    >
                      ...
                      highlight your skills, BisResume’s templates offer unique
                      designs that will help you stand out.
                    </Text>
                    ...
                    >
                      ...
                      clearly display all your career highlights so far.
                    </Text>
                  </Box>
                  ...
                  <Box marginTop="5%">
                    ...
                    >
                      ...
                      each new role that you apply for.
                    </Text>
