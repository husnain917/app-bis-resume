                    ...
                    >
                        ...
                        >
                            <Box p={["5%", "5%"]} >
                                ...
                                <Text fontSize={["20px"]} className={"sub-heading"} fontWeight={"bold"} >	Master the Art of Resume Writing: A Step-by-Step Guide for Beginners
                                </Text>
                                ...
                                {/*  step  */}
                                <Box mt={["3%", "3%", "3%"]}>
                                    <Text fontSize={["22px"]} className={"sub-heading"} >How to Write a Resume </Text>
                                    <OrderedList ml={["4%", "5%", "5%"]}>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>Choose a resume format that highlights your strengths and experiences in the most effective way.</ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>Include your personal details and contact information prominently in your resume.</ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>Use a resume summary or objective to grab the attention of hiring managers and give them a snapshot of your qualifications and experiences.</ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>List your work experience and achievements in a clear and organized manner, highlighting your relevant skills and accomplishments.</ListItem>

                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>Mention your top soft and hard skills to demonstrate your qualifications and capabilities.</ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>Consider including additional resume sections such as languages, hobbies, and certifications to showcase your unique skills and experiences.</ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>Tailor your resume to the specific job ad by including relevant keywords and phrases and highlighting your qualifications that match the job requirements.</ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>Create a compelling cover letter that explains why you are the best candidate for the job and how your skills and experiences align with the position.</ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>Proofread your resume and cover letter multiple times to ensure they are error-free and easy to read.</ListItem>
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    <Text fontSize={["24px"]} fontWeight={["bold"]} className={"sub-heading"} > How to Make a Resume </Text>
                                    <Text fontSize={'1rem'} className={"only-font-family"} mt={["2%", "3%", "3%"]}>
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    <Text fontWeight={["bold"]} fontSize={["24px"]} className={"sub-heading"}>Creating a Winning Resume: A Proven Guide for Success</Text>
                                    <Text fontSize={'1rem'} className={"only-font-family"} mt={["2%", "3%", "3%"]}>
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    <Text fontWeight={["bold"]} fontSize={["24px"]} className={"sub-heading"}>	Maximize Your Job Search: The Ultimate Guide to Choosing the Right Resume Format</Text>
                                    <Text fontSize={'1rem'} className={"only-font-family"} mt={["2%", "3%", "3%"]}>
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    <Text fontSize={["24px"]} className={"sub-heading"} fontWeight={["bold"]} >Creating a Winning Resume Layout</Text>
                                    <Text fontSize={'1rem'} className={"only-font-family"} mt={["1%", "2%", "2%"]}>
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    <Text fontSize={["24px"]} className={"sub-heading"} fontWeight={["bold"]} >The Ultimate Resume Layout Checklist: How to Create a Professional and Organized Resume</Text>
                                    <OrderedList ml={["4%", "5%", "5%"]}>
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    <Text fontSize={["24px"]} className={"sub-heading"} fontWeight={["bold"]} >Creating a Winning Resume: A Guide to What to Include</Text>

                                    <Text fontSize={'1rem'} className={"only-font-family"} mt={["1%", "2%", "2%"]}>
                                        The most popular sections for a resume are:
                                    </Text>
                                    <UnorderedList ml={["4%", "5%", "5%"]}>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>Tailor your contact information to include your name, professional email address, phone number, and location.
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} >Use a resume summary or objective statement to provide a brief overview of your qualifications and career goals.
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} >Detail your relevant work experience, including job titles, companies, and key responsibilities and achievements.
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} >Highlight your education, including degrees and certifications earned.
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} >List your top skills, both hard and soft, that are relevant to the position you're applying for.
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} >
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    ...
                                    <UnorderedList ml={["4%", "5%", "5%"]}>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} fontWeight={["bold"]}>	A professional-sounding email address (avoid using personal or unprofessional email addresses)
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} fontWeight={["bold"]} >A phone number where you can be reached during business hours
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} fontWeight={["bold"]}>Your current city and state (or country if applying for an international job)
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} fontWeight={["bold"]}>	A personal website or portfolio, if applicable. It is also important to make sure that your contact information is up-to-date and that your voicemail message and email address are professional.

                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"} ><b>A LinkedIn profile, if you have one</b>
                                        </ListItem>
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    ...
                                    <UnorderedList ml={["4%", "5%", "5%"]}>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b>  LinkedIn URL:-</b> Yes, including a link to an up-to-date professional profile such as LinkedIn can add value to a job application by providing the employer with additional information about your skills, experience, and professional network.
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b>  Title:-</b>
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    <Text fontSize={["24px"]} className={"sub-heading"} fontWeight={["bold"]} >There are a few things you should not include in the contact information section of a job application or resume:</Text>

                                    <UnorderedList ml={["4%", "5%", "5%"]}>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b> Date of Birth</b> It can be your position, word-for-word, or your desired job. Think “Digital Marketing Specialist”.
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                        ...
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            ...
                                            The HR manager's main focus is to evaluate the candidate's qualifications, skills, and experience for the job. A photograph is not necessary for this evaluation, and it's also important to consider that adding a photo to your application may create a bias, regardless of whether it's intentional or not.                                    </ListItem>
                                    </UnorderedList>
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    ...
                                    {/*  step  */}
                                    <Box mt={["3%", "3%", "3%"]}>
                                        <Text fontSize={["24px"]} className={"sub-heading"} >	How to List Work Experience in a Resume </Text>
                                        <OrderedList ml={["4%", "5%", "5%"]}>
                                            <ListItem fontSize={'1rem'} className={"only-font-family"}>List your work experience in reverse chronological order, starting with your most recent position.</ListItem>
                                            <ListItem fontSize={'1rem'} className={"only-font-family"}>Use clear and concise language to describe your job title, company, and job responsibilities.</ListItem>
                                            <ListItem fontSize={'1rem'} className={"only-font-family"}>Use bullet points to make your work experience easy to read and navigate.</ListItem>
                                            <ListItem fontSize={'1rem'} className={"only-font-family"}>	Use action verbs and quantifiable metrics to demonstrate the impact of your work. For example, "managed a team of 10 employees and increased sales by 15%.".</ListItem>

                                            <ListItem fontSize={'1rem'} className={"only-font-family"}>Include any relevant volunteer or extracurricular experiences that demonstrate your relevant skills and experience.</ListItem>
                                            <ListItem fontSize={'1rem'} className={"only-font-family"}>Tailor your work experience to the specific job you are applying for by highlighting the skills, qualifications, and experience that are most relevant to the position.</ListItem>
                                            <ListItem fontSize={'1rem'} className={"only-font-family"}>Be honest and accurate when describing your work experience, and don't exaggerate your responsibilities or accomplishments.</ListItem>
                                            <ListItem fontSize={'1rem'} className={"only-font-family"}>Make sure to proofread your resume to ensure that there are no typos or grammatical errors.</ListItem>
                                    ...
                                    <Box mt={["3%", "3%", "3%"]} >
                                        <Text fontSize={["24px"]} className={"sub-heading"} fontWeight={["bold"]} >Creating a Winning Resume: A Proven Guide for Success</Text>
                                        <Text fontSize={'1rem'} className={"only-font-family"} mt={["2%", "3%", "3%"]}>
                                    ...
                                    <Box mt={["3%", "3%", "3%"]} >
                                        ...
                                        <Text fontSize={'1rem'} className={"only-font-family"} mt={["2%", "3%", "3%"]}>
                                          By using our guide and our resume builder, you can unlock the potential of your resume and increase your chances of getting the job you want.</Text>
                                        <OrderedList ml={["4%", "5%", "5%"]}>
                                    ...
                                    <Box mt={["3%", "3%", "3%"]} >
                                        ...
                                        <Text fontSize={'1rem'} className={"only-font-family"} mt={["1%", "2%", "2%"]}>
                                        In this guide, we will share some of the best practices when it comes to creating a winning resume layout. From choosing the right font and formatting to organizing your sections and making it easy to read, we'll show you how to make your resume stand out and leave a lasting impression.</Text>
                                    ...
                                    <Box mt={["3%", "3%", "3%"]} >
                                        ...
                                        <UnorderedList ml={["4%", "5%", "5%"]}>
                                            ...
                                            <ListItem fontSize={'1rem'} className={"only-font-family"} >Include any additional sections that may be relevant to the job or showcase your unique qualifications, such as languages spoken or publications authored.
                                            </ListItem>
                                        </UnorderedList>
                                        <Text fontSize={'1rem'} className={"only-font-family"} mt={["1%", "2%", "2%"]}>
...
The Education section of your resume is where you can showcase your educational background and academic achievements. It's important to format this section correctly and include all relevant information to demonstrate your qualifications and skills to potential employers.
                                    ...
                                    <Text fontSize={'1rem'} className={"only-font-family"} mt={["1%", "2%", "2%"]}>
                                        ...
                                        Here are the basic elements you should include in the Education section of your resume:
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    ...
                                    <UnorderedList ml={["4%", "5%", "5%"]}>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b> Program Name.</b> The full name of the degree or program you completed, such as "B.A. in Business Administration"
                                        </ListItem>

                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b>University Name.</b> The full name of the university or institution you attended, such as "New York State University"
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b> Years Attended.</b>The dates you attended the program or institution, such as "08/2008 - 06/2012"
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b>    (Optional) GPA.</b> Your grade point average, such as "3.9 GPA"
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b> (Optional) Honors.</b> Any academic honors or distinctions you received, such as "Cum Laude" or "Magna Cum Laude"


                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b>   (Optional) Academic achievements. </b> Any papers you've written, courses you've excelled in, or other academic achievements that demonstrate your knowledge and skills.
                                        </ListItem>
                                        <ListItem fontSize={'1rem'} className={"only-font-family"}>
                                            <b>  (Optional) Minor.</b>: Any minor or additional program you completed, such as "Minor in Psychology."
                                ...
                                <Box mt={["3%", "3%", "3%"]} >
                                    ...
                                    <Text fontSize={'1rem'} className={"only-font-family"} mt={["1%", "1%", "1%"]}>
                                        <b> Step #1 -</b> - List Hard Skills with Experience Levels: Clearly state your proficiency level for each hard skill you list. This can be done by dividing them into beginner, intermediate, advanced, and expert levels. Be honest about your skill levels, as lying could lead to negative consequences.
                                    </Text>
                                    <Image
                                    ...
                                    <Text fontSize={'1rem'} className={"only-font-family"} mt={["1%", "1%", "1%"]}>
                                        <b>  Step #2 - Tailor Your Skills to the Job.</b> Tailor Your Skills to the Job: Make sure to mention 2-3 essential skills required for the job as stated in the job ad. This will show the employer that you are a good fit for the position.
                                    ...
                                    <Text fontSize={'1rem'} className={"only-font-family"} mt={["1%", "2%", "2%"]} >
                                        <b> Step #3 -</b> Include Some Universal Skills: Universal skills, such as leadership, teamwork, critical thinking, and common software skills, are useful for almost any job. Even if they are not specifically required for the position, it's still beneficial to mention them in your resume.
