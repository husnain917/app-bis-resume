export const data = [
  {
    ...
    exampleData: [
      ...
      {
        label: "Fashion Designer3",
        src: "realTemp20.PNG",
        alt: "random from unsplash",
        link: "/templates/6iz8Y7EFbpAos1dn",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    exampleData: [
      ...
      },
      {
        ...
        src: "realTemp11.PNG",
        alt: "random from unsplash",
        link: "/templates/QbnlV2ff7hB3mbdx",
      },
      {
        label: "Graphic Designer1",
        src: "realTemp7.PNG",
        alt: "random from unsplash",
        link: "/templates/UaMsr4yxtyAJ0d9T",
      },
      {
        label: "Graphic Designer2",
        src: "realTemp17.PNG",
        alt: "random from unsplash",
        link: "/templates/pC5lVexxlHtEY2v2",
      },
      {
        label: "Graphic Designer3",
        src: "realTemp24.PNG",
        alt: "random from unsplash",
        link: "/templates/zY7eR3FNn1HaM2Kd",
      },
      {
      ...
      },
      {
        ...
        src: "realTemp21.PNG",
        alt: "random from unsplash",
        link: "/templates/dhqAtIa3jaWjxQLb",
      },
      {
      ...
      },
      {
        ...
        src: "realTemp25.PNG",
        alt: "random from unsplash",
        link: "/templates/0S4gN5d6gsN4xFd2",
      },
    ],
  },
  {
    ...
    exampleData: [
      ...
      },
      {
        ...
        src: "realTemp12.PNG",
        alt: "random from unsplash",
        link: "/templates/PhhchnzxtXfKZXBz",
      },
      {
        label: "Digital Marketing",
        src: "realTemp9.PNG",
        alt: "random from unsplash",
        link: "/templates/pSJl09vc4C39lNL3",
      },
      {
      ...
      },
      {
        ...
        src: "realTemp1.PNG",
        alt: "random from unsplash",
        link: "/templates/zyCeSJJ2A8fEGNRx",
      },
    ],
  },
  {
    ...
    exampleData: [
      {
        ...
        src: "realTemp31.PNG",
        alt: "random from unsplash",
        link: "/templates/6nJppDLrOJST3qF2",
      },
      {
        label: "Tech Temp",
        src: "realTemp30.PNG",
