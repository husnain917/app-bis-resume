...
export const PREMIUM_ACCOUNT_DATA = [
    ...
    {
        label: 'The information on BisResume is complete, true, accurate or non-misleading.',
    },
    {
        label: 'That BisResume will meet your requirements.',
    },
    {
        label: 'That BisResume will be available at any particular time or location, uninterrupted or secure.',
    },
    {
        label: 'That BisResume will be 24/7 active all the time.',
    },
    {
        label: 'Your data will be saved all the time in your account, and that data loss will never occur. However, we will do our best to make sure all the information is saved in your account for a flawless experience. Data loss is very unlikely.',
    },
]
...
export const CONTACT_US_DATA = [
    {
        label: 'istLink',
        description: 'If you feel like something is missing or misleading in our Terms of Use, please feel free to notify us.',
        mail: ''
    },
    {
        label: 'secondLink',
...
export const TERMS_DATA = {
    ...
    WarrantyAndPremiumAccount: {
        ...
        description: 'BisResume strives to provide the best service and products, but you understand and agree that BisResume is provided „as is” and „as available” without any representations or warranties, express or implied. Without prejudice, BisResume does not warrant that:',
        paragraphs: [
            {
