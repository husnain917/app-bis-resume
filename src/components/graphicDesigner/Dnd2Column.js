...
import styles from '../../../styles/templates/dnd2column.module.scss';
    ...
    if (props.data) {
      ...
      if (props.data.length > 0) {
        props.data.map((item, index) => {
          if (index % 2 === 0) {
            return column1.push(item);
          } else {
            return column2.push(item);
          }
        });
        return {
          column1,
                          ...
                          >
                            ...
                            >
                              <Tooltip title="Add New Item" arrow distance={20}>
                                <i
                                  className={'material-icons ' + styles.dndIcon}
                                >
                                  add
                                </i>
                              </Tooltip>
