...
export const RESUME_TABLE_DATA = {
    istContent: {
        title: "Resume Formatting",
        link: "b1"
    },
    secContent: {
        title: "Examples of Well-Formatted Resumes You Can Use",
        link: "b2"
    },
    thirdContent: {
        title: "The Three Main Resume Formats",
        link: "b3",
        data: [
            {
            ...
            {
                text: "Skills-Based / Functional",
                link: "b3ii"
            },
            {
                text: "Hybrid / Combination",
                link: "b3iii"
            },
            {
                text: "Recap: How to Pick the Best Resume Format for You",
                link: "b3iv"
            },
        ]
    },
...
export const RESUME_FORMATS = {
    ...
    secTitle: "For a professional resume, follow these 10 resume formatting steps:",
...
export const RESUME_EXAMPLES = {
    ...
    examplesContent: [
        {
            ...
            description: "Nanica is one of the all-time favorites among our users, despite being a super simple resume format. The best thing about it? A very universal design with lots of white space. Highly recommended for job applications in conservative fields: law, finance, general business."
        },
        {
            title: "Graphic Designer",
            img: "/formateTemp2.jpg",
            description: "Another uncluttered resume format available in our builder. Simple and elegant yet with a modern touch. Primo uses a timeline on the left-hand side to make your work experience and education dates easier to track. A sidebar for your skills and extra sections lets you save space and fit more information onto a single page."
        },
        {
    ...
    resumeOrderSection: [
        ...
        {
            text: "Resume Summary or Resume Objective"
        },
        {
        ...
        {
            text: "Additional Resume Information"
        },
    ],
    reverseResume: [
        {
    ...
    skillResumeFormats: {
        istContent: {
            ...
            description: "The two crucial components of a functional resume are the resume objective at the very top and the skills summary. This is how to write them step by step:"
        },
        secContent: {
    ...
    recapFormatsTable: {
        tableHeadings: [
            ...
            {
                text: "Reverse-Chronological Resume"
            },
            {
                text: "Functional Resume"
            },
            {
                text: "Combination Resume"
            },
        ],
        tableBodyData: [
            {
                rowData: [
                    ...
                    {
                        text: "Skills and work experience",
                    },
                ]
            },
            {
                rowData: [
                    ...
                    {
                        text: "At the top, relevant",
                    },
                    {
                        text: "At the bottom, irrelevant",
                    },
                    {
                        text: "In the middle, relevant",
                    },
                ]
            },
            {
            ...
            },
            {
                rowData: [
                    ...
                    {
                        text: "Easy to read, universal",
                    },
                    {
                        text: "Conceals flaws in work history",
                    },
                    {
                        text: "Emphasizes and validates skills",
                    },
                ]
            },
            {
            ...
            },
            {
                rowData: [
                    ...
                    {
                        text: "Career changers or employment-gappers with very complicated work histories",
                    },
                    {
                        text: "Students, experienced professionals, career changers, entry-level candidates",
                    },
                    {
                        text: "Entry-level candidates, students",
                    },
                ]
            },
        ]
...
export const PASS_SCAN_FORMATS = {
...
export const RESUME_FORMATS_EXTRA_TIPS = {
    data: [
        {
            text: "Resume Layout Tips: Typography, Spacing, Margins, Fonts, and More"
        },
        {
            text: "Resume Design Inspirations and a Full How-to Guide"
        },
        {
            text: "Well-Formatted Resume Templates"
        },
        {
            text: "One- or Two-Page? How Long Should a Resume Be?"
        },
        {
            text: "Infographic Resume Format: How to Make It Work?"
        },
        {
            text: "Tailored/Targeted Resume Format: How to Make a Resume Match the Job Ad"
        },
        {
            text: "Resume Examples for Every Profession (99+)"
        },
        {
            text: "US Resume Format (American Style Resume Template)"
        },
        {
            text: "40+ Job-Winning Resume Tips & Tricks"
        },
    ],
    strategies: {
        title: "To have a resume format that gets you the job, use these key strategies:",
        data: [
            {
                text: "Apply the standard resume formatting rules: one-inch margins, elegant font, 11–12pt font size, single line spacing, additional space before and after headings."
            },
            {
                text: "Choose one of the standard types of resumes: reverse-chronological, combination, or functional resume format. Pick the proper resume format for your individual situation."
            },
            {
                text: "The format of a resume is mostly about dividing it into proper sections. In this order: contact info, summary, work experience, education, skills, and extra sections."
            },
            {
                text: "Save space using bullet points in your work experience and education sections."
            },
        ],
