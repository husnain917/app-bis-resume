...
export const RESUME_EXAMPLES = {
  ...
  skillResumeFormats: {
    ...
    secContent: {
      ...
      description:
        "Mention software you are proficient in and quantify your skills whenever possible. Use bullet points or plain paragraphs to make the information easy to read.",
    },
  },
  hybridFormats: [
    {
...
export const PASS_SCAN_FORMATS = {
  ...
  description:
    "	Tailoring your resume to the job description and making it as relevant as possible to the position you are applying for.",
};
