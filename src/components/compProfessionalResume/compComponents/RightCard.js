...
export default function RightCard({ cardData }) {
  ...
  return (
    <Box bg='white' minHeight={width >= 767 ? "fit-content" : "300px"} borderRadius="10px" py={4} px={6} my={5} >
      ...
      {cardData.text === "1" ?
        <Text fontSize="17px" textAlign="justify" fontFamily="'Nunito',Helvetica,Arial,sans-serif" color="#002d6b" mt={2}>
