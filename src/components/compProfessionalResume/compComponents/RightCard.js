...
export default function RightCard({ cardData}) {
  ...
  return (
    <Box bg='white' display={width >= 767 ? "auto":"flex" } flexDirection={width >= 767 ? "auto": "Column" } justifyContent="center" alignItems="center" minHeight={width >= 767 ? "fit-content" : {base:530,sm:350}} borderRadius="10px" py={4} px={6} my={5} mx={3} >
