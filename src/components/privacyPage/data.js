export const PRIVACY_PAGE_DATA = [
  ...
  {
    label: "YOUR RIGHTS AND HOW TO WITHDRAW CONSENTS AND UNSUBSCRIBE",
    href: "a8",
  },
  {
...
export const CONTACT_US_DATA = [
  {
    ...
    description2: "or our Chief Privacy Officer Andrei Kurtuy at ",
    mail2: "contact@bisResume.com.",
  },
  {
    label: "istLink",
    description: [
...
export const PRIVACY_DATA = {
    ...
    data: [
      {
        ...
        description:
          " The legal basis for processing the personal data of the interested party which is collected is the execution of the service agreement. In this regard, the interested party is obliged to provide that data necessary for its execution. If we are not provided with this data, our services can’t be performed.",
      },
      {
        heading: "Legal obligations",
        description:
          " The sending of feedback questionnaires about the services, results which will be used to know users' opinion and how the services can be improved.",
      },
      {
        heading: "Consent",
        description:
        ...
        description2:
          "The withdrawal of consent of said processing on the part of the interested party may affect the execution of the service agreement.",
      },
      {
  ...
  Changes: {
    ...
    data: [
      ...
      {
        text: "This use may include some personal information as follows: IP address, cookies, etc.",
      },
      {
        text: "This processing is made under the legitimate interest of the company (Article 6(1)(f) GDPR) and is based on the aforementioned purposes. By using our services, users understand and agree that Novoresume cannot be held responsible in case of any unauthorized and wrongful use by such third-party service providers (e.g. cookie high jacking).",
      },
      {
        text: "Users may, for reasons arising from their particular situation, object to such legitimate processing at any time by writing us at",
        link: "contact@novoresume.com",
      },
    ],
  },
  BreachesOfTheseTermsOfUse: {
    heading: "8. YOUR RIGHTS AND HOW TO WITHDRAW CONSENTS AND UNSUBSCRIBE",
    data: "You have certain rights according to the applicable data protection regulation. Some of the rights are rather complex and include exemptions, accordingly you are recommended to read relevant laws and guidance from the regulatory authorities for a full explanation of these rights. However, you can find a summary of your rights, if you unfold below sections.",
    subData: [
      {
      ...
      {
        heading: "8.3 The right to erasure",
        description:
          "In some cases, you have the right to erasure of your personal data without undue delay. Those circumstances include; i) the personal data is no longer necessary in relation to the purposes for which it was collected or otherwise processed; ii) you withdraw consent to consent-based processing; iii) the processing is for direct marketing purposes and iv) the personal data has been unlawfully processed. However, there are certain general exclusions of the right to erasure. Those general exclusions include where processing is necessary; i) for exercising the right of freedom of expression and information; ii) for compliance with legal obligations; or iii) for the establishment, exercise or defense of legal claims.After some of your personal data was erased based on your request, some copies of it might still be stored in our backups for a maximum of 190 days. The reason why we do not automatically erase the data from our backups is that it might create security risks. If you want more information about this,",
        link: "please contact our",
      },
      {
        heading: "8.4 The right to restriction of processing",
        description:
      ...
      {
        heading: "8.5 The right to data portability",
        description:
      ...
      {
        heading: "8.7 The right to withdraw consent",
        description:
      ...
      {
        heading:
          "8.8 The right to complaint to data protection supervisory authority",
        description:
          "You may always lodge a complaint with your local data protection supervisory authority. The data protection supervisory authority in Denmark, you can find their contact information ",
        description2:
        ...
        description3p1:
          "Please contact us through the points of contact listed in",
        description3p2:
          "Please also provide us with relevant information to take care of your request, including your full name and email address so that we can identify you. We will respond to your request without undue delay.",
        link1: "here",
        link2: " Our contact details ",
        description4:
